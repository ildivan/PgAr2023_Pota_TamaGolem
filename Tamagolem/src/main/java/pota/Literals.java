...
public class Literals {
    ...
    public static final String GOLEMS_REMAINING_HEALTH = "TamaGolems' remaining health: ";
    ...
    public static final String SAME_STONES_ERROR = AnsiColors.RED + "The two Golems cannot have the same stones!"
            + AnsiColors.RESET;
    ...
    public static final String EDIT_NAME = "Edit name: %s";
    public static final String PRESS_ENTER_TO_CONTINUE = "\n\nPress Enter to continue...";
    public static final String CURRENT_PLAYER_NAME = "The current name is %s, insert the new one: ";
